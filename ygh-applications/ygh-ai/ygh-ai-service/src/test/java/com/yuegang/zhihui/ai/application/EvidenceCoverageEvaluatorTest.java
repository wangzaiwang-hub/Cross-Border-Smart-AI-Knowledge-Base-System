...
class EvidenceCoverageEvaluatorTest {
    ...
    void requiresCitationsAndSixtyPercentOfExpectedEvidence() {
        ...
        var result = evaluator.evaluate(response, "有效政策版本、发布机构、生效日期、交易限值", "无需核对现行政策");
